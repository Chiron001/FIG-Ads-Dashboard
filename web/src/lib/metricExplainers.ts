...
export const METRIC_EXPLAINERS: Record<string, MetricExplainer> = {
  ...
  "Google Sessions": { formula: "GA4 sessions, channel = Paid Search", description: "GA4's own channel classification (real event data), not a utm_source guess." },
  "Meta Sessions": { formula: "GA4 sessions, channel = Paid Social", description: "GA4's own channel classification (real event data), not a utm_source guess." },
